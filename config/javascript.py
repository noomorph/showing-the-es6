...
class JavascriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'[})\].]', Punctuation),
            (r'(for|in|of|while|do|break|return|yield*|continue|switch|case|default|if|else|'
             r'throw|try|catch|finally|new|delete|typeof|instanceof|void|yield|'
             r'this)\b', Keyword, 'slashstartsregex'),
            (r'(var|let|const|with|function*?)\b', Keyword.Declaration, 'slashstartsregex'),
            (r'(abstract|boolean|byte|char|class|debugger|double|enum|export|'
             r'extends|final|float|goto|implements|import|int|interface|long|native|'
             r'package|private|protected|public|short|static|super|synchronized|throws|'
             r'transient|volatile)\b', Keyword.Reserved),
            (r'(true|false|null|NaN|Infinity|undefined)\b', Keyword.Constant),
            (r'(Array|Boolean|Date|Error|Function|Math|netscape|'
             r'Number|Object|Packages|RegExp|Symbol|String|sun|decodeURI|'
