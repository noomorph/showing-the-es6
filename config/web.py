...
class JavascriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'[})\].]', Punctuation),
            (r'(for|of|in|while|do|break|return|continue|switch|case|default|if|else|'
            ...
            (r'(Array|Boolean|Date|Error|Symbol|Function|Math|netscape|'
    ...
    *New in Pygments 1.3.*
    ...
    tokens = {
        ...
        'statements': [
            ...
            (r'(for|in|of|while|do|break|return|continue|switch|case|default|if|'
...
class HaxeLexer(RegexLexer):
    ...
    *New in Pygments 1.3.*
    ...
    tokens = {
        ...
        'codekeywords': [
            (r'\b(if|else|while|do|for|of|in|break|continue|'
